...
$req = $bdd->query('SELECT COUNT(id) as nbArticle FROM blog WHERE categorie="8" ');
$data = $req->fetch();
...
$getBlog = $bdd->query('SELECT * FROM blog WHERE categorie="8" ORDER by date_article DESC LIMIT ' . (($cPage - 1) * $perPage) . ',' . $perPage);
...
<head>
    ...
    <title><?php echo $site_title . ' - Actualités' ?></title>
    <!-- Favicon -->
    ...
    <main class="mt-5 pt-5">
        <div class="container-fluid pt-2">
            ...
            <section class="text-center  mt-5">
                ...
                <h2 class=" text-white p-2">Blog - Actualités</h2>
                ...
                <nav class="d-flex justify-content-center wow fadeIn">
                    <ul class="pagination pg-blue">
                        ...
                        <li class="page-item <?php if ($cPage == "1") {
                            ...
                            <a class="page-link" href="<?php echo $url_path . 'blog.php?page=' . ($cPage - 1);  ?>" aria-label="Previous">
                        ...
                        <?php for ($i = 1; $i <= $nbPage; $i++) { ?>
                            ...
                            <?php } else { ?>
                                ...
                                <li class="page-item ">
                                    <a class="page-link" href="<?php echo $url_path . 'blog.php?page=' . $i ?>"><?php echo $i ?>
                        ...
                        <li class="page-item <?php if ($cPage == $nbPage) {
                            ...
                            <a class="page-link" href="<?php echo $url_path . 'blog.php?page=' . ($cPage + 1);  ?>" aria-label="Next">
